  ...
  const formattedEvaluations = useMemo(() => {
    ...
    return allEvaluations.map((item) => {
      ...
      return {
        ...
        // تثبيت تنسيق التاريخ على العربية المصرية ar-EG دائماً
  ...
  return (
    <div className="evaluations-container">
      ...
      <div className="table-footer">
        ...
        <p>
          <span className="tip-label">النصيحة : </span>
          حافظ على التدريبات المستمرة لتحسين نقاط الضعف والارتقاء بمستوى اللاعب.
        </p>
      </div>
    </div>
  );
