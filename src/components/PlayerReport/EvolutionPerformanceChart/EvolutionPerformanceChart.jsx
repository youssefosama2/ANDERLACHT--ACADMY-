...
const EvolutionPerformanceChart = ({ evolutionInView }) => {
  ...
  return (
    <div className="chart-card evolution-card">
      ...
      {loading ? (
        <div style={{ height: 300, display: "flex", alignItems: "center", justifyContent: "center", color: "#64748b", fontWeight: "600" }}>جاري تحميل البيانات...</div>
      ) : evolutionData.length === 0 ? (
        <div style={{ height: 300, display: "flex", alignItems: "center", justifyContent: "center", color: "#64748b", fontWeight: "600" }}>لا توجد بيانات</div>
      ) : (
